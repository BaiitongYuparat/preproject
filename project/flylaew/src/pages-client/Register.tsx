...
const Register: React.FC = () => {
    ...
    const [showPassword, setShowPassword] = React.useState(false); //show
    const [showConfirmPassword, setShowConfirmPassword] = React.useState(false); //เช็คว่าpasswordตรงกันไหม

...
// import FlightsdepartCard from "./FlightsdepartCard";


// interface FlightdepartData {
//     id: string;
...
// const FlightsdepartCardList: React.FC = () => {
//     const [flights, setFlights] = useState<FlightdepartData[]>([]);
...
//             try {
//                 setLoading(true);
//                 const response = await axios.get<FlightdepartData[]>("/FlightData.json");
...
// export default FlightsdepartCardList;
